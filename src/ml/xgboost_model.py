...
def train_and_evaluate_model(
    ...
    ys_train_and_val_path = Path(
        "../../../plot-streaming-data/src/plot_streaming_data/data/XGBoost/val"
    )
...
def test_model(
    ...
    ys_test_path = Path(
        "../../../plot-streaming-data/src/plot_streaming_data/data/XGBoost/test"
    )
...
def pipeline_xgboost():
    ...
    if (minio_client.bucket_exists(bucket_name=bucket)) and (
        ...
        infsess = download_model_from_minio(model="xgb", minio_client=minio_client)
        ...
        xgb, X_train, X_val, y_train, y_val, params_, model_metrics = (
